...
typedef void (*firmware_ptr_t)(void);

typedef struct
{
  wsfTimerTicks_t     period;     /*!< \brief Firmware exe timer expiration period in ms */
} fwUpdateCfg_t;


extern wsfTimer_t fwExeTimer; /*! \brief periodic firmware execution timer */
