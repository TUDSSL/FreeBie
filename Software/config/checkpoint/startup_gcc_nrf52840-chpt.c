...
{
    char *data = (char *)&_sdata;

    char *data_init = (char *)&_init_data;
    uint32_t start_offset = data - (char *)&_sdata_norestore;
    data_init = &data_init[start_offset];

    uint32_t size = (char *)&_edata - (char *)&_sdata;
...
void
startup_clear_data_network(void)
{
    char *data = (char *)&_sdata_network;

    char *data_init = (char *)&_init_data;
    uint32_t start_offset = data - (char *)&_sdata_norestore;
    data_init = &data_init[start_offset];

    uint32_t size = (char *)&_edata_network - (char *)&_sdata_network;
    for (uint32_t i=0; i<size; i++) {
        data[i] = data_init[i];
    }
}
...
void
startup_clear_data_application(void)
{
    char *data = (char *)&_sdata_application;

    char *data_init = (char *)&_init_data;
    uint32_t start_offset = data - (char *)&_sdata_norestore;
    data_init = &data_init[start_offset];

    uint32_t size = (char *)&_edata_application - (char *)&_sdata_application;
    for (uint32_t i=0; i<size; i++) {
        data[i] = data_init[i];
    }
}
...
{
    char *bss = (char *)&_sbss;
    uint32_t size = (char *)&_ebss - (char *)&_sbss;
    for (uint32_t i=0; i<size; i++) {
        bss[i] = 0;
    }
}
...
void
startup_clear_bss_network(void)
{
    char *bss = (char *)&_sbss_network;
    uint32_t size = (char *)&_ebss_network - bss;
    for (uint32_t i=0; i<size; i++) {
        bss[i] = 0;
    }
}
...
void
startup_clear_bss_application(void)
{
    char *bss = (char *)&_sbss_application;
    uint32_t size = (char *)&_ebss_application - bss;
    for (uint32_t i=0; i<size; i++) {
        bss[i] = 0;
    }
}
