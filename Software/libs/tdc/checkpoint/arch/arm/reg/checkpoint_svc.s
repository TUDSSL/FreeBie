...
SVC_Handler:
    ...
    */
    ...
    ldr r0, [sp,#24] // Get the return address of the stack
    ldr r0, [r0,#-2] // Get the instruction of the return address (assumes thumb instructions)
    bic r0, r0, 0xffffff00 // Thumb only last 8 bits are valid

    /* If svc number equals CHECKPOINT_RESTORE_FLAG jump to restore */
    cmp     r0, #43
    beq     b_restore

    /* Write the checkpoint_svc_restore to 0 */
    ...
    */
    ...
    /* Write the checkpoint_svc_restore to 1 */
    ldr     r0, =checkpoint_svc_restore
    mov     r1, #1
    str     r1, [r0]
